...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-server-mathjax-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12388&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-server-mathjax-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-server-mathjax` can be installed with:

```
conda install jupyter-server-mathjax
```

It is possible to list all of the versions of `jupyter-server-mathjax` available on your platform with:
